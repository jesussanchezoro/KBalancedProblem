...
public class KBalancedSolver2Obj {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String instanceSet = (args.length>0)?args[0]:"two_of";
        String algorithm = (args.length>0)?args[2]:"OMOPSO";
        int evals = (args.length>0)?Integer.parseInt(args[3]):250000;
        int popSize = (args.length>0)?Integer.parseInt(args[4]):100;
        ...
        for (String fileName : fileNames) {
            ...
            NondominatedPopulation result = new Executor()
                    .withProblemClass(KBalanceProblem2Obj.class, path)
